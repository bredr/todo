...
function isGrpcWebUnaryAction(action: Action<any>): action is GrpcAction<jspb.Message, jspb.Message> {
...
export const grpcRequest = <RequestType extends jspb.Message, ResponseType extends jspb.Message>() => createAction("GRPC_WEB_REQUEST", (action) => {
  return (payload: GrpcActionPayload<RequestType, ResponseType>) => action(payload);
});
